...
def create_doctor_agent(llm, check_symptoms, recommend_medicine, tavily_tool):
    # Define the tools the agent will be able to use
...
2. For emergencies, direct the patient to immediate care.
...
6. Maintain an empathetic, professional tone.
